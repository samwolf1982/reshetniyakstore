...
<div class="container">
          ...
          <?php if ($tags) { ?>
			...
			<div class="form-group">
				...
				<div class="add-to-links">
					<button class="button btn-wishlist" type="button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><span><?php echo $button_wishlist; ?></span></button>
					<button class="button btn-compare" type="button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><span><?php echo $button_compare; ?></span></button>
				</div>
			</div>
    ...
    <?php echo $column_right; ?>
      ...
      <div class="module-title"><h2><?php echo $text_related; ?></h2></div>
      <div class="row">
