<div id="cart" class="btn-group btn-block">
	...
	<ul class="dropdown-menu pull-right">
		...
		<div class="row2-cart  div-bordered">
			  ...
			  <?php } ?>
			<div class="button-cart text-right"><a class="view-cart" href="<?php echo $cart; ?>"><strong><?php echo $text_cart; ?></strong></a><a  class="checkout-cart" href="<?php echo $checkout; ?>"><strong><?php echo $text_checkout; ?></strong></a></div>
		</div>
		</li>
		<?php } else { ?>
		<li>
