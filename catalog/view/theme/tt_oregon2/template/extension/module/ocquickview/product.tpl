          ...
          <div id="product">
		   ...
		   <div class="form-group">
				...
				<div class="add-to-links">
					<button class="button btn-wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="addWishlist('<?php echo $product_id; ?>');"><span><?php echo $button_wishlist; ?></span></button>
					<button class="button btn-compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="addCompare('<?php echo $product_id; ?>');"><span><?php echo $button_compare; ?></span></button>
				</div>
			</div> 	
		  <p class="short-des">
