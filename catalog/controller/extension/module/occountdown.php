			...
			foreach ($results as $result) {
				...
				if(strtotime($date_start) && strtotime($date_end)) {
					$data['products'][] = array(
						...
						'name'        	=> $result['name'],
						'description' => utf8_substr(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8')), 0,50, $this->config->get($this->config->get('config_theme') . '_product_description_length')) . '..',
						'orgprice'      => $price,
						'special'     	=> $special,
